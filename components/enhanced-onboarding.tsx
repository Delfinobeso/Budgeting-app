    ...
    <div className="min-h-screen bg-black font-sans overflow-hidden">
      ...
      {step === 1 && (
        <div className="relative min-h-screen flex flex-col items-center justify-center p-6">
          ...
          >
            <h1 className="text-4xl font-bold text-white mb-4">Benvenuto su Mobius!</h1>
            <p className="text-gray-400 text-lg mb-8 max-w-md mx-auto">
              Iniziamo insieme a dare forma al tuo budget: semplice, chiaro, sotto controllo.
            </p>
        ...
        <div className="min-h-screen bg-gray-50 p-6 animate-slide-up">
          <div className="max-w-md mx-auto pt-12">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-black mb-2">Distribuisci il tuo budget in modo intelligente</h1>
              <p className="text-gray-600">Personalizza come vuoi spendere i tuoi €{totalBudget}</p>
            </div>
            ...
            <Card className="bg-white rounded-3xl shadow-lg p-6 mb-6">
              <CardContent className="p-0 text-center">
                ...
                >
                  {Math.abs(totalPercentage - 100) <= 1
                    ? "Perfetto! Il budget è bilanciato."
                    : totalPercentage > 100
        ...
        <div className="min-h-screen bg-gray-50 p-6 animate-slide-up">
          <div className="max-w-md mx-auto pt-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Ecco come hai organizzato il tuo budget mensile</p>
            </div>
